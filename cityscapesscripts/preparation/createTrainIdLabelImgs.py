...
import os, glob, sys
data_path=r'/app/wht/paddle/apcnet/cityscapesscripts/dataset'
# cityscapes imports
# print(os.path.normpath( os.path.join(os.path.dirname( data_path ), 'helpers' ) ) )
...
def main():
    ...
    cityscapesPath = r'/app/wht/paddle/apcnet/dataset'
